	...
	cases := []testCase2{
		{
			...
			g:      gf.detach(),
			strs:   []string{"detach a", "detach temp", "detach database a", "detach database temp"},
			firsts: []token.Kind{token.KindDetach, token.KindDetach, token.KindDetach, token.KindDetach},
			lasts:  []token.Kind{token.KindIdentifier, token.KindTemp, token.KindIdentifier, token.KindTemp},
		}, {
			g:      gf.dropIndex(),
			pos:    []int{0, 2, 5},
			strs:   []string{"drop index a", "drop index temp.a", "drop index if exists temp.a"},
			...
			g:      gf.dropTable(),
			pos:    []int{0, 2, 5},
			strs:   []string{"drop table a", "drop table temp.a", "drop table if exists temp.a"},
			firsts: []token.Kind{token.KindDrop, token.KindDrop, token.KindDrop},
			lasts:  []token.Kind{token.KindIdentifier, token.KindIdentifier, token.KindIdentifier},
		}, {
			g:      gf.dropTrigger(),
			...
			g:      gf.dropView(),
			pos:    []int{0, 2, 5},
			strs:   []string{"drop view a", "drop view temp.a", "drop view if exists temp.a"},
			firsts: []token.Kind{token.KindDrop, token.KindDrop, token.KindDrop},
			lasts:  []token.Kind{token.KindIdentifier, token.KindIdentifier, token.KindIdentifier},
		}, {
			g:    gf.pragma(),
			...
			g:      gf.reindex(),
			strs:   []string{"reindex", "reindex a", "reindex a.a", "reindex temp.a"},
