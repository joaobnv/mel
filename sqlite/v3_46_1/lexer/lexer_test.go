...
func TestLexer(t *testing.T) {
	cases := []struct {
		...
		{code: ":2", tokens: parseTokens(`<":2", ColonVariable> <EOF>`)},
		{code: ":table", tokens: parseTokens(`<":table", ColonVariable> <EOF>`)},
		{code: ":tab$le::(schema)", tokens: parseTokens(`<":tab$le::(schema)", ColonVariable> <EOF>`)},
		...
		{code: ":$", tokens: parseTokens(`<":$", ColonVariable> <EOF>`)},
		{code: ":", tokens: parseTokens(`<":", ErrorUnexpectedEOF> <EOF>`)},
		{code: ":?", tokens: parseTokens(`<":", ErrorInvalidCharacterAfter> <"?", QuestionVariable> <EOF>`)},
		{code: "@2", tokens: parseTokens(`<"@2", AtVariable> <EOF>`)},
		{code: "@table", tokens: parseTokens(`<"@table", AtVariable> <EOF>`)},
		{code: "@tab$le::(schema)", tokens: parseTokens(`<"@tab$le::(schema)", AtVariable> <EOF>`)},
		...
		{code: "@$", tokens: parseTokens(`<"@$", AtVariable> <EOF>`)},
		{code: "@", tokens: parseTokens(`<"@", ErrorUnexpectedEOF> <EOF>`)},
		{code: "@?", tokens: parseTokens(`<"@", ErrorInvalidCharacterAfter> <"?", QuestionVariable> <EOF>`)},
		{code: "$2", tokens: parseTokens(`<"$2", DollarVariable> <EOF>`)},
		...
		{code: "$$", tokens: parseTokens(`<"$$", DollarVariable> <EOF>`)},
		{code: "$", tokens: parseTokens(`<"$", ErrorUnexpectedEOF> <EOF>`)},
		{code: "$?", tokens: parseTokens(`<"$", ErrorInvalidCharacterAfter> <"?", QuestionVariable> <EOF>`)},
		{code: "$tab::le", tokens: parseTokens(`<"$tab::le", DollarVariable> <EOF>`)},
